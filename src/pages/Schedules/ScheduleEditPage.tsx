...
export const ScheduleEditPage: React.FC<ScheduleEditPageProps> = ({ onNavigate, isNew, scheduleId }) => {
  ...
  const loadSchedule = async () => {
    try {
      const response = await getBackendSrv().get(`/api/plugins/scheduled-reports-app/resources/api/schedules/${scheduleId}`);
  ...
  const handleSubmit = async () => {
    ...
    try {
      if (isNew) {
        await getBackendSrv().post('/api/plugins/scheduled-reports-app/resources/api/schedules', formData);
      } else {
        await getBackendSrv().put(`/api/plugins/scheduled-reports-app/resources/api/schedules/${scheduleId}`, formData);
      }
